...
func main() {
	...
	log.Printf("Phone: %s", res.Phone) // Task 2: แสดงข้อมูลเบอร์โทรศัพท์

	// Task 1: เรียกใช้ ListStudents เพื่อดึงรายชื่อนักเรียนทั้งหมด
	...
	if err != nil {
		log.Fatalf("Error marshaling students: %v", err)
	}
