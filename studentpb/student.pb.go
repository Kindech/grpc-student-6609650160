...
// Task 1: เพิ่ม Message เปล่าสำหรับเรียก List
type Empty struct {
...
// Task 1: เพิ่ม Message สำหรับตอบกลับรายการนักเรียน (ใช้ repeated)
...
type StudentResponse struct {
	...
	// Task 2: เพิ่มฟิลด์เบอร์โทรศัพท์
...
const file_proto_student_proto_rawDesc = "" +
	...
	"\x05phone\x18\x05 \x01(\tR\x05phone2\x8f\x01\n" +
...
var file_proto_student_proto_goTypes = []any{
	...
	(*StudentRequest)(nil),      // 2: student.StudentRequest
	(*StudentResponse)(nil),     // 3: student.StudentResponse
}
var file_proto_student_proto_depIdxs = []int32{
	3, // 0: student.StudentListResponse.student:type_name -> student.StudentResponse
	2, // 1: student.StudentService.GetStudent:input_type -> student.StudentRequest
	0, // 2: student.StudentService.ListStudents:input_type -> student.Empty
	3, // 3: student.StudentService.GetStudent:output_type -> student.StudentResponse
	1, // 4: student.StudentService.ListStudents:output_type -> student.StudentListResponse
